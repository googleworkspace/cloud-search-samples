...
/**
 * Simple integration tests for dictionary sample.
...
public class IntegrationTests {
  ...
  /**
   * Verify that sample can successfully define at least one term
   */
  @Test
  public void testUploadDictionary() throws Exception {
    ByteArrayOutputStream outputStream = captureOutput();
    DictionarySample.main(new String[]{"--datasource", dataSourceId});
    assertThat(outputStream.toString()).contains("Defined term:");
  }
}
